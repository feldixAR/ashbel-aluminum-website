...
export const productFamilies = [
  ...
  },
  {
    ...
    intro: 'תריסים, שלבי אור, ארגזי תריס, מנועים והכנות לבית חכם. פתרונות שמאפשרים שליטה באור, פרטיות ונוחות שימוש יומיומית.',
  ...
  },
  {
    ...
    kicker: 'גדרות, שערים, מסתורים, זכוכית ומקלחונים',
