...
export const productFamilies = [
  {
    ...
    intro: 'חלונות ודלתות במראה בלגי או כפרי, עם חלוקות זכוכית, פרופילים דקים, ידיות וגוונים שמתאימים לאופי הבית.',
    ...
    subOptions: ['חלונות בלגיים', 'דלתות בלגיות', 'מחיצות פנים', 'סדרה כפרית', 'גוונים ופרזול'],
  ...
  },
  {
    slug: 'modern-style',
    title: 'המראה המודרני',
    kicker: 'חלונות ציר, קיפ, הזזה ומינימל',
    intro: 'חלונות אלומיניום בקו נקי לבית ולשיפוץ: ציר, קיפ, דריי קיפ, הזזה, סדרת מינימל, זכוכית רחבה וגמרים מודרניים.',
    ...
    subOptions: ['חלונות ציר וקיפ', 'חלונות הזזה', 'סדרת מינימל', 'רשתות לחלונות', 'זכוכית וגמרים'],
  ...
  },
  {
    ...
    intro: 'ויטרינות, דלתות הזזה ומפתחים גדולים לסלון, מרפסת, גינה וחללי אירוח, עם התאמה למסילות, רשתות, ניקוז וזכוכית.',
  ...
  },
  {
    ...
    intro: 'תריסים, בתי תריס, ארגזים סמויים, מנועים ופרגולות אלומיניום, עם תיאום לפי שלב הבנייה, החשמל והחזית.',
