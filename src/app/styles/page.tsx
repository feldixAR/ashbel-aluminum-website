      ...
      <div className='container-main'>
        ...
        <section className='section-shell body-copy'>
          <SectionHeader
            ...
            text='בשלב מוקדם כדאי לבדוק חזיתות, כיווני שמש, סוג פתחים, דרישות פרטיות, צבעים וגמרים, ורק אז לסגור סדרה וחלוקות.'
          />
          <p>בפרויקטים פרטיים איכותיים, בחירת אלומיניום מוקדמת מונעת פשרות מאוחרות במפלסים, תריסים, מסילות, רשתות ומפגש עם חיפויים.</p>
        </section>

        <CtaBand title='מתלבטים בין סגנונות?' text='שלחו תוכנית או תמונה מהחזית, ונכוון אתכם לבחירת מערכות אלומיניום שמתאימות לבית ולשלב הפרויקט.' />
      </div>
    </main>
  );
}
