    ...
    <main>
      ...
      <section className='container-main section-shell'>
        <SectionHeader
          ...
          title='בחירת סדרה לפי צורך אדריכלי ותפעולי'
          text='אפשר לעבוד עם סדרות מוכרות של קליל ועם משפחות פתרונות נוספות, אבל ההתאמה נעשית לפי המפתח, השימוש, התקציב, הגמר והשלב שבו הפרויקט נמצא.'
        />
      ...
      <section className='container-main section-shell'>
        <SectionHeader
          eyebrow='פרויקטים'
          title='כשהתמונות המקוריות ייכנסו, הן יחליפו דוגמאות תרחיש'
          text='אין באתר הצגה של לקוחות, מיקומים או פרויקטים שלא אומתו. כרגע מוצגים תרחישים שמסבירים את סוגי העבודה הרלוונטיים.'
        />
        <div className='grid-3'>
