      ...
      <div className='container-main'>
        ...
        <section className='section-shell'>
          ...
          <div className='grid-3'>
            {[
              ['דיוק במדידה', 'פתחים, מפלסים, מסילות, זכוכית, תריסים ורשתות נבדקים לפני ייצור.'],
        ...
        <section className='section-shell body-copy'>
          ...
          <p>הדרך הנוחה להתחיל היא לשלוח תוכניות, תמונות, מידות או רשימת פתחים, ואנחנו נכוון מה כדאי לבדוק בשלב הבא.</p>
        </section>
