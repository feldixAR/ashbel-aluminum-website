...
await writeFile(path.join(dir, 'ai-review-current.txt'), `commit=${commit}\nrun=${run}\ntimestamp=${timestamp}\nimage=${jpgName}\nhtml=${htmlName}\n`, 'utf8');
await writeFile(path.join(dir, 'ai-review-meta.json'), `${JSON.stringify({ commit, run, timestamp, image: jpgName, html: htmlName }, null, 2)}\n`, 'utf8');
